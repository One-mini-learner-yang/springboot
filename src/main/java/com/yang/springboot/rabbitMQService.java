...
//    }
    ...
    public void rabbitMQService(){
        Map map=new HashMap();
        map.put("yang","nb");
        System.out.println(new SimpleDateFormat("yyyy-MM-dd-HH:mm:ss").format(new Date())+"发送消息");
    ...
    public void rabbitListener(Message message,Channel channel) throws IOException {
